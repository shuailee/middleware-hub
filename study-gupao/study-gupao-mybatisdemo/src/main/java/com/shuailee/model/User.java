...
/**
 *  * 如果开启了MyBatis的二级缓存，则需要将javabean 实现Serializable接口
 * */
public class User implements Serializable {
    ...
    public User(String user_name, String user_sex, String user_birthday, String user_email, String user_edu, String user_telephone, String user_address) {
